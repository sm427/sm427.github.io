  ...
  render() {
    ...
    return (
      <div className="HT-container">
        ...
        <p className="HT-text"> Before you start playing, log in with Google. Head to your profile via the navigation bar and change your username.</p>

        <h2>Singleplayer</h2>

        <p className="HT-text">Upload a picture in your profile. Only you will be able to see this picture. Make sure to follow the instructions on the profile page on how to crop the photo before uploading to secure that the game works properly.</p>
