    ...
    if (!this.state.profileUser) {
      ...
      return(
        ...
        <div className="u-flex Profile-ContentContainer">
          ...
          <p className="Profile-PictureExplanation">  Add a picture of your face; make sure that you look directly at the camera, that your head isn't tilted in any direction, that the picture is well-lighted and that your face isn't covered by hair in front of your forehead or glasses.</p>
          <p className="Profile-PictureExplanation">Crop the picture of your face such that your face completly fills the image. Your chin should lay on the bottom edge of the image; the top edge should be between your hairline and the top of your head. The left and the right edge of the image should be where your ears start. Please see the example picture below.</p>
          <p className="Profile-PictureExplanation">Save the image and upload it here.</p>
          <p className="Profile-PictureExplanation">Optional: For the best experience, make sure that your image has a width of 200px and a height of 300px; distort it if neccessary. If your graphics editor supports it, change the colors to 8-bit, in order to decrease the file size. Save as .png.</p>
