  ...
  // }
    ...
    return (
      ...
      <div className="u-textCenter Home-singlePlayerContentContainer">
        ...
        <p>You'll play  {this.state.sliderValue} rounds.</p><p className="u-Quantico">Note: Picture Count is not working because there is only one playable picture in the MVP. The number of playable pictures will be significantly increased for the final product. The final product will only let the user start the game when he has uploaded a picture.</p></div>
         {startbutton} 
      </div>
      </div>
    );
